...
### Added (Builder D/Graphics)
- **📊 Percentil-rang i Analytics** — var dagens förmögenhet ligger i sin egen historik.
- **📈 Typisk-upp-dag-stat i Analytics** — snitt-vinst en plus-dag.
- **🗓️ Denna-vecka-räknare i Notifications** + **💬 kvar-till-milstolpe-tooltip på Home.**

### Tested
- EditMode 1286/1286, PlayMode 188/188 på merged main (batch om 4).
...
### Added (Builder D/Graphics)
- **📉 Drawdown-från-topp i Analytics** — hur mycket du fallit från all-time-high.
- **🏁 Startvärde-rad i Analytics** — vad du startade perioden på.
- **💬 Exakta belopp i Home-allokerings-tooltip.**
...
### Added (Builder D/Graphics)
- **🔢 Net-worth count-up i Analytics** — animerad upp-räkning av nettoförmögenheten.
- **💬 Exakt milstolpe-mål-tooltip på Home** — hovra milstolpe-baren för det exakta målbeloppet.
- **📐 Kort/nav-avdelare i Tips.**
...
### Added (Builder D/Graphics)
- **🍂 Säsong-råd i Forecast & på Home** — säsongsanpassade skötsel-tips (t.ex. brumation på vintern).
- **✨ Forecast-dagskorten fadar in** när de byggs.

### Tested
- EditMode 1254/1254, PlayMode 188/188 på merged main (batch om 3).
...
### Added (Builder D/Graphics)
- **🥧 Allokerings-procent + ⭐ dominant tillgång i Analytics** — pajen visar nu procent och markerar den största posten.
- **🔮 Milstolpe-ETA på Home** — uppskattad tid till nästa pengar-milstolpe.
- **✨ Hover-highlight på Controls-rader.**

### Tested
- EditMode 1252/1252, PlayMode 188/188 på merged main (batch om 4).
...
### Added
- **🏁 Animerad pengar-milstolpe-bar på Home** (Builder D/Graphics) — milstolpe-baren fyller animerat mot nästa mål.
...
### Added
- **✨ Hover-highlight på notis-rader** (Builder D/Graphics) — notis-rader markeras subtilt vid pekare-hovring.
...
### Added
- **📰 Financial news feed** (Builder B/Economy) — dagliga makro-rubriker som färgar marknadssentimentet
  och ger kontext åt prisrörelser.

### Tested
- EditMode 1216/1216, PlayMode 182/182 på merged main.
